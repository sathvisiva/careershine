...
angular.module('careershineApp').factory('Programs', function ($resource) {
...
angular.module('careershineApp').factory('Colleges', function ($resource) {
...
angular.module('careershineApp').factory('Courses', function ($resource) {
...
angular.module('careershineApp').factory('Enquiry', function ($resource) {
...
angular.module('careershineApp').factory('Blog', function ($resource) {
...
angular.module('careershineApp').service('NavbarService', function ($http, Courses, Colleges) {
  var myData = null;
